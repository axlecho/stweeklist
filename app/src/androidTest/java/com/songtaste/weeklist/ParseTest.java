...
public class ParseTest extends AndroidTestCase {
    ...
    public void testGetWeeklist() {
        List<StTrackInfo> SongList = STWeeklistApi.getWeeklist("2009-09-28");
        Assert.assertEquals(50, SongList.size());
        StTrackInfo si = SongList.get(19); // 第20首歌
    ...
    public void testGetMp3Url() {
        String url = STWeeklistApi.getMp3Url(27158);
    ...
    public void testGetDateList() {
        try {
            List<String> datelist = STWeeklistApi.getDateList();
            LogUtil.d(datelist);
